...
import { Eye, EyeOff, Zap, Target, TrendingUp, CheckCircle } from 'lucide-react'
...
function LeftPanel() {
  ...
  const perks = ['Full access for 7 days', 'No credit card needed', 'Cancel anytime']
  ...
  return (
    <div className="hidden lg:flex flex-col justify-between relative overflow-hidden bg-gradient-to-br from-indigo-950 via-indigo-900 to-violet-900 p-12 text-white">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <span className="font-semibold text-lg tracking-tight">Appy<span className="text-indigo-300">Doer</span></span>
      </div>
        ...
        <div className="space-y-2">
          {perks.map(perk => (
            <div key={perk} className="flex items-center gap-2">
              ...
              <span className="text-sm text-indigo-200">{perk}</span>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="min-h-screen grid lg:grid-cols-[440px_1fr]">
      ...
      <div className="flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Start your free trial</h1>
            <p className="text-gray-500 text-sm mt-1">7 days full access · No credit card required</p>
          </div>
